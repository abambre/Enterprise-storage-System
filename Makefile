unifiedFS: dropbox file_tracking
	gcc -Wall -g -D_FILE_OFFSET_BITS=64 -DFUSE_USE_VERSION=26 unifiedFS.c -o unifiedFS dropbox_storage.o file_tracking.o  `pkg-config --cflags --libs glib-2.0` `pkg-config fuse --cflags --libs` -lpthread -lfuse -lcrypto -lssl -lmemstream -ldropbox -lfuse
