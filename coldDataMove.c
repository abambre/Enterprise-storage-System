...
int main (int argc, char **argv) {
    ...
    char *c_key    = "sxio4nooiaklk54";  //< consumer key
    char *c_secret = "9f6040i71tllzah";  //< consumer secret
    
    // User key and secret. Leave them NULL or set them with your AccessToken.
    char *t_key    = "KSkQCyhUYNIAAAAAAAAABd5jl8qDAtzZAe37HR9-ZFHglnAiB1iZQpl_VnEdeZrC"; //< access token key
